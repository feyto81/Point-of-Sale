...
<ul class="app-menu">
  ...
  <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-shopping-cart"></i><span class="app-menu__label">Transaction</span><i class="treeview-indicator fa fa-angle-right"></i></a>
    <ul class="treeview-menu">
      ...
      <li><a class="treeview-item active" href="{{url('/stock-out/all')}}"><i class="icon fa fa-circle-o"></i> Stock Out</a></li>
...
<main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <a href="{{url('/stock-out/add-stock-out')}}" class="btn btn-sm btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add Stock Out</a>&nbsp;
        </div>
      </div>
      <br>
      <div class="row">
          ...
          $('.btn-delete').click(function(){
            ...
            const swalWithBootstrapButtons = Swal.mixin({
              ...
              swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                  window.location = "/stock-out/delete-stock/"+stockout_id+"";
                } else if (
