...
@section('title','Report Month | Kasir')
@section('menu')
<ul class="app-menu">
  ...
  <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-book"></i><span class="app-menu__label">Report</span><i class="treeview-indicator fa fa-angle-right"></i></a>
    <ul class="treeview-menu">
      ...
      <li><a class="treeview-item active" href="{{url('/report/month')}}"><i class="icon fa fa-circle-o"></i> Month</a></li>
...
<main class="app-content">
      ...
      <div class="row">
        <div class="col-md-6">
            <div class="tile">
                <div class="tile-body">
                    <form class="navbar-form navbar-right" role="search" action="{{url('/report/sale/month')}}">
