...
<ul class="app-menu">
  ...
  <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-truck"></i><span class="app-menu__label">Supplier</span><i class="treeview-indicator fa fa-angle-right"></i></a>
    <ul class="treeview-menu">
      <li><a class="treeview-item active" href="{{url('/supplier/addsupplier')}}"><i class="icon fa fa-circle-o"></i> Add Supplier</a></li>
...
<main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{url('/add-barang')}}">Add Supplier</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            ...
            <div class="tile-body">
              <form action="{{url('supplier/saveAdd')}}" method="post">
                {{ csrf_field() }}
         ...
         @endif
            ...
            <div class="tile-footer">
              ...
              <a href="{{url('/supplier/all')}}" class="btn btn-warning btn-flat">
