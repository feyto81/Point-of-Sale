...
@section('title','All Supplier | Kasir')
@section('menu')
<ul class="app-menu">
  ...
  <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-truck"></i><span class="app-menu__label">Supplier</span><i class="treeview-indicator fa fa-angle-right"></i></a>
    <ul class="treeview-menu">
      ...
      <li><a class="treeview-item active" href="{{url('/supplier/all')}}"><i class="icon fa fa-circle-o"></i> All Supplier</a></li>
    </ul>
  </li>
...
<main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <a href="{{url('/supplier/addsupplier')}}" class="btn btn-sm btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add Supplier</a>&nbsp;
          <a href="{{url('/supplier/export-excel')}}" class="btn btn-sm btn-info"><i class="fa fa-file-excel-o"></i> Export Excel</a>&nbsp;
          <a href="{{url('/supplier/export-pdf')}}" target="_blank" class="btn btn-sm btn-warning"><i class="fa fa-file-pdf-o"></i> Export PDF</a>&nbsp;
          ...
          $('.btn-delete').click(function(){
            ...
            const swalWithBootstrapButtons = Swal.mixin({
              ...
              swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                  window.location = "/supplier/delete-supplier/"+supplier_id+"";
                } else if (
