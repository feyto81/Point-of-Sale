...
<ul class="app-menu">
  ...
  <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-truck"></i><span class="app-menu__label">Supplier</span><i class="treeview-indicator fa fa-angle-right"></i></a>
    <ul class="treeview-menu">
      ...
      <li><a class="treeview-item" href="/supplier/all')}}"><i class="icon fa fa-circle-o"></i> All Supplier</a></li>
    </ul>
  </li>
          ...
          <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Pemasukan Detail</h5>
                  ...
                  <table class="table table-bordered no-margin">
                    <tbody>
                      <tr>
                        ...
                        <td><span id="pemasukan_count"></span></td>
                      </tr>
                      <tr>
...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Pemasukan</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <a href="{{url('/pemasukan/export-excel')}}" class="btn btn-sm btn-info"><i class="fa fa-file-excel-o"></i> Export Excel</a>&nbsp;
          <a href="{{url('/pemasukan/export-pdf')}}" target="_blank" class="btn btn-sm btn-warning"><i class="fa fa-file-pdf-o"></i> Export PDF</a>&nbsp;
        </div>
      </div>
      <br>
      <div class="row">
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  @foreach($pemasukan as $p)
                    <tr>
                      ...
                      <!-- diffForHumans untuk manusia-->
                       <td>
                            <a title="Detail" id="set_dtl" class="btn btn-warning btn-sm" 
                              data-toggle="modal" data-target="#modal-detail"
                              data-pemasukan_count="@currency($p->pemasukan_count)"
                              data-keterangan="{{$p->keterangan}}"
                              data-created_at="{{$p->created_at->format('d-m-Y')}}"
                              data-updated_at="{{$p->updated_at->format('d-m-Y')}}">
                              <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{url('/pemasukan/edit-pemasukan/'.$p->pemasukan_id)}}" title="Edit Data" class="btn btn-primary btn-sm"><i class="fa fa-pencil fa-sm"></i></a>
                            <a href="#" class="btn btn-danger btn-sm btn-delete"  title="Hapus Data" pemasukan-id="{{$p->pemasukan_id}}"><i class="fas fa-sm fa fa-trash"></i></a>
                        </td>
                    </tr>
                  @endforeach
                  </tbody>
            ...
            <div class="modal-content">
              <form action="{{url('/pemasukan/add')}}" method="POST">
                ...
                <div class="modal-body">
                    {{csrf_field()}}
                  <div class="form-group{{$errors->has('pemasukan_count') ? 'has-error' : '' }}">
                    <label for="pemasukan_count">Jumlah</label>
                    <input name="pemasukan_count" type="text" class="form-control" id="pemasukan_count" aria-describedby="emailHelp"  value="">
                  </div>
                  <div class="form-group{{$errors->has('keterangan') ? 'has-error' : '' }}">
                    <label for="keterangan">Keterangan</label>
                    <input name="keterangan" type="text" class="form-control" id="keterangan" aria-describedby="emailHelp" value="">
                  </div>
...
@push('bottom')
          ...
          $('.btn-delete').click(function(){
            ...
            const swalWithBootstrapButtons = Swal.mixin({
              ...
              swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                  window.location = "/pemasukan/delete-pemasukan/"+pemasukan_id+"";
                } else if (
    ...
    $(document).ready(function() {
      $(document).on('click', '#set_dtl', function() {
        var jumlah = $(this).data('pemasukan_count');
        var keterangan = $(this).data('keterangan');
        var created_at = $(this).data('created_at');
        var updated_at = $(this).data('updated_at');
        $('#pemasukan_count').text(jumlah);
