...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Add Unit</h1>
          <p>Fill items carefully</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="{{url('/add-barang')}}">Add Unit</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Add Unit</h3>
            <div class="tile-body">
              <form action="{{url('/save-unit')}}" method="post">
                {{ csrf_field() }}
            ...
            <div class="tile-footer">
              ...
              <a href="{{url('/unitall')}}" class="btn btn-warning btn-flat">
