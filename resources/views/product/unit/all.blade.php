...
<ul class="app-menu">
  ...
  <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-archive"></i><span class="app-menu__label">Products</span><i class="treeview-indicator fa fa-angle-right"></i></a>
    <ul class="treeview-menu">
      ...
      <li><a class="treeview-item active" href="{{url('/unitall')}}"><i class="icon fa fa-circle-o"></i> Units</a></li>
...
<main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <a href="{{url('/add-unit')}}" class="btn btn-sm btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add Unit</a>&nbsp;
        </div>
      </div>
      <br>
      <div class="row">
                      ...
                      <tr>
                        ...
                        <td>
                          <a title="Detail Data" id="set_dtl" class="btn btn-warning btn-sm" 
                            ...
                            <a href="{{url('/edit-unit/'.$row->unit_id)}}" title="Edit Data" class="btn btn-primary btn-sm"><i class="fa fa-pencil fa-sm"></i></a>
                          <a href="#" class="btn btn-danger btn-sm btn-delete"  title="Hapus Data" unit-id="{{$row->unit_id}}"><i class="fas fa-sm fa fa-trash"></i></a>
                        </td>
                      </tr>
                    @endforeach
                  </tbody>
          ...
          $('.btn-delete').click(function(){
            ...
            const swalWithBootstrapButtons = Swal.mixin({
              ...
              swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                  window.location = "/delete-unit/"+unit_id+"";
                } else if (
