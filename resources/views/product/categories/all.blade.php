...
@section('title','All Category | Kasir')
@section('menu')
<ul class="app-menu">
  ...
  <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-archive"></i><span class="app-menu__label">Products</span><i class="treeview-indicator fa fa-angle-right"></i></a>
    <ul class="treeview-menu">
      <li><a class="treeview-item active" href="{{url('/categoryall')}}"><i class="icon fa fa-circle-o"></i> Categories</a></li>
...
<main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <a href="{{url('/add-category')}}" class="btn btn-sm btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add Category</a>&nbsp;
        </div>
      </div>
      <br>
      <div class="row">
                      ...
                      <tr>
                        ...
                        <td>
                          <a title="Detail Data" id="set_dtl" class="btn btn-warning btn-sm" 
                            ...
                            <a href="{{url('/edit-category/'.$item->category_id)}}" title="Edit Data" class="btn btn-primary btn-sm"><i class="fa fa-pencil fa-sm"></i></a>
